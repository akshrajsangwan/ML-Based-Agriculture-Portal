...
<head>
  ...
  <title>Admin Login - Agriculture Portal</title>
...
<body class="bg-white">
  ...
  <section class="section section-shaped section-lg" style="min-height: 90vh; display:flex; align-items:center;">
    <!-- Background Image -->
    <div class="hero-bg" style="background-image: url('../assets/img/bg4.png'); filter: brightness(0.6);"></div>
          ...
          <div class="card bg-secondary shadow border-0" style="backdrop-filter: blur(10px); background: rgba(255,255,255,0.95);">
            <div class="card-header bg-white pb-3">
              <div class="text-center">
                <h4 class="text-success font-weight-bold mb-0">Admin Portal</h4>
              </div>
            </div>
              ...
              <form method="post" action="">
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Admin ID" type="text" name="admin_name" required>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Password" type="password" name="admin_password" id="password" required>
                ...
                <div class="text-center">
                  <button type="submit" name="adminlogin" class="btn btn-primary-custom my-4 w-100">Login</button>
                </div>
